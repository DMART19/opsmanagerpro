...
-- Admin RPC to list all workspace snapshots with workspace info
...
-- Admin RPC to restore any workspace (bypasses user_id ownership)
...
-- Admin RPC to create a snapshot for any workspace
