...
import type { AttributeType, CreateAttributeInput } from "@/hooks/use-requirement-attributes";

interface AddRequirementAttributeModalProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  onSubmit: (input: CreateAttributeInput) => Promise<any>;
  isLoading?: boolean;
}
...
export const AddRequirementAttributeModal = ({
  open,
  onOpenChange,
  onSubmit,
  isLoading,
}: AddRequirementAttributeModalProps) => {
        ...
        <div className="space-y-5 py-4">
          ...
          <div>
            ...
            <Input
              ...
              placeholder="e.g. Training Hours, Cost, Provider"
              className="mt-1.5"
              autoFocus
            />
          </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                Must be filled when adding a credential
              </p>
            </div>
            <Switch
              id="required"
